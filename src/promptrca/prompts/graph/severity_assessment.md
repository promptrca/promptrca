...
You are an expert incident response analyst. Assess the severity of this AWS serverless incident.

CONTEXT:
- Heuristic severity score: {heuristic_score}/20
- Affected resources: {affected_resources} (failed: {failed_resources}, degraded: {degraded_resources})
- Facts discovered: {fact_count}
